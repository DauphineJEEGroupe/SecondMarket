...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Information sur la société
               
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">Information sur la société</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul id="myTab" class="nav nav-tabs nav-justified">
                    <li class="active"><a href="#service-one" data-toggle="tab"><i class="fa fa-tree"></i> SociÃ©tÃ©</a>
                    </li>
                    <li class=""><a href="#service-two" data-toggle="tab"><i class="fa fa-database"></i> Chiffres</a>
                    </li>
                    <li class=""><a href="#service-four" data-toggle="tab"><i class="fa fa-car"></i> ActualitÃ©s</a>
                    </li>
                    <li class=""><a href="#service-three" data-toggle="tab"><i class="fa fa-database"></i> Informations financiÃ¨res</a>
                    </li>
                </ul>
