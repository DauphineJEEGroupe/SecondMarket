        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul id="myTab" class="nav nav-tabs nav-justified">
                    <li class="active"><a href="#service-one" data-toggle="tab"><i class="fa fa-tree"></i> Société</a>
                    </li>
                    <li class=""><a href="#service-two" data-toggle="tab"><i class="fa fa-database"></i> Chiffres</a>
                    </li>
                    <li class=""><a href="#service-four" data-toggle="tab"><i class="fa fa-car"></i> Actualités</a>
                    </li>
                    <li class=""><a href="#service-three" data-toggle="tab"><i class="fa fa-database"></i> Informations financières</a>
                    </li>
                </ul>
