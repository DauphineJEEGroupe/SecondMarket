...
<body>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="AccrÃ©ditationSociÃ©tÃ©.html">AccrÃ©diter SociÃ©tÃ©</a>
                    </li>
                     <li>
    ...
    <TR>
        <TH>Nom Utilisateur</TH> <TH> Prénom</TH> <TH>Date de naissance</TH><TH>Email</TH><TH>Profession</TH><TH>Tél</TH>
    </TR>
    <TR>
        <TD width=33%>A</TD> <TD width=33%>B</TD> <TD width=33%>C</TD><TD width=33%>C</TD><TD width=33%>A</TD><TD width=33%>A</TD>
    </TR>
    <TR>
        <TD>D</TD> <TD>E</TD> <TD>F</TD><TD>C</TD><TD>A</TD><TD>A</TD>
    </TR>
</TABLE>
