        ...
        <!-- Service Tabs -->
            ...
            <div class="col-lg-4 ">
                ...
                <ul id="myTab" class="nav nav-justified">
                    ...
                    <li class="active"><a href="AccréditationSociété.html" >Accréditer Société</a>
                    </li>
                    <li class=""><a href="profilAdminRecherche.html" ><i class="fa fa-search"></i> Recherches</a>
                    </li>
                </ul>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i> Informations administrateur?</h4>
                    </div>
